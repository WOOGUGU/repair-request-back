package com.kkkoke.networkrepair.util.aop;

import com.kkkoke.networkrepair.exception.RequestLimitException;
...
//            return "接口请求超过次数";
            throw new RequestLimitException("request over limit");
...
//            CREATED;
            uc.put(request.getRemoteAddr(), uCount + 1, ExpirationPolicy.CREATED, requestLimit.time(), TimeUnit.MILLISECONDS);
        } else { // 未超过次数， 记录加一
