...
public class PickerTimeServiceImpl implements PickerTimeService {
    ...
    // 增加报修时间段
    @Override
    public PickerTime addPickerTime(String time) throws DataHasExistedException {
        // 查看数据库中是否已经存在此报修时间段
    ...
    // 删除报修时间段
    @Override
    public int deletePickerTime(Integer pickerId) throws DataHasNotExistedException {
    ...
    // 根据id查找某个时间段
    @Override
    public PickerTime selectPickerTime(Integer pickerId) throws DataHasNotExistedException {
        // 根据用户名查找pickerTime
        PickerTime pickerTime = pickerTimeDao.selectPickerTime(pickerId);
        // 判断查询结果是否为空
        if (ObjectUtils.isEmpty(pickerTime)) {
            throw new DataHasNotExistedException("PickerTime has existed");
        } else {
            return pickerTime;
        }
    }
    ...
    // 根据time查找某个报修时间段
    @Override
    public PickerTime selectPickerTimeByTime(String time) throws DataHasNotExistedException {
        // 根据area查找PickerTime
    ...
    // 查找所有时间段
    @Override
    public List<PickerTime> selectAllPickerTime() throws DataHasNotExistedException {
    ...
    // 修改时间段
    @Override
    public PickerTime updatePickerTime(Integer pickerId, String time) throws DataHasNotExistedException {
        // 创建要修改的PickerTime对象
