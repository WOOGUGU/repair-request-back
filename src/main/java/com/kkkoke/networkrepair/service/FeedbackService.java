...
public interface FeedbackService {
    ...
    // 根据id查找反馈
    Feedback selectFeedbackById(Integer feedbackId) throws DataHasNotExistedException;

    // 查找反馈
    List<Feedback> selectFeedback(Integer feedbackId, Integer uid, String content, String tel);
}
